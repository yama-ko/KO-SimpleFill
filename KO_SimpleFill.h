...
// Popup indices are 1-based; separators occupy index slots.
// Layout: Normal(1) | sep(2) | Add(3) | NegAdd(4) | Multiply(5) | Screen(6)
//       | sep(7) | Overlay(8) | HardLight(9) | sep(10) | Lighten(11) | Darken(12) | Difference(13)
#define POPUP_TOTAL_ITEMS 13
